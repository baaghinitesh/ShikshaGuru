...
export default function TeacherProfilePage() {
  ...
  const handleWhatsAppContact = () => {
    if (teacher?.whatsappNumber) {
      const message = encodeURIComponent(`Hi ${teacher.fullName}, I found your profile on ShikshaGuru and I'm interested in your teaching services.`);
      window.open(`https://wa.me/${teacher.whatsappNumber.replace(/[^0-9]/g, '')}?text=${message}`, '_blank');
    }
  };
